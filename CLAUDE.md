...
Use the existing Claude Code skills as the primary implementation guidance. Use repo-local guards and CI-style gates as the final source of truth when there is any conflict.
...
1. `C:\Users\ntgpt\.claude\skills\flutter-app-development\SKILL.md`
2. if the task is implementing or reviewing Flutter UI from provided wireframe or mockup images, also load:
   - `C:\Users\ntgpt\.claude\skills\flutter-wireframe-to-ui\SKILL.md`
3. the mode-specific Flutter skill if the task clearly fits one:
   - `C:\Users\ntgpt\.claude\skills\flutter-full-app\SKILL.md`
   - `C:\Users\ntgpt\.claude\skills\flutter-frontend-client\SKILL.md`
4. `D:\workspace\lumos\00_docs\architecture\flutter\lumos_flutter_architecture_contract.md`
...
- Never read or edit auto-generated Dart files: `*.g.dart`, `*.freezed.dart`, `*.gr.dart`, `*.gen.dart`, `*.mocks.dart`, `*.config.dart`, `*.pb.dart`, and any file whose header contains `// GENERATED CODE - DO NOT MODIFY BY HAND`. Edit the source file that drives the generator instead, then re-run `build_runner`.
...
1. `C:\Users\ntgpt\.claude\skills\spring-boot-rest-api\SKILL.md`
