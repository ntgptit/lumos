...
class LumosTimeField extends StatefulWidget {
  const LumosTimeField({
    super.key,
    this.label,
    this.supportingText,
    this.labelTrailing,
  ...
  @override
  State<LumosTimeField> createState() => _AppTimeFieldState();
}

class _AppTimeFieldState extends State<LumosTimeField> {
  ...
  @override
  void didUpdateWidget(covariant LumosTimeField oldWidget) {
